  ...
  return (
    <div className="w-full px-2">
      ...
      <div className="flex bg-primary items-center text-white mt-4">
        <h1 className="flex-1 font-bold text-2xl py-1">Tokens Swap Settings</h1>
      ...
      {/* TABLE */}
      <TokenTransactionSettingsTable data={tokenTransactionSettingList.SWAP} loading={loading} />
    </div>
  );
};
